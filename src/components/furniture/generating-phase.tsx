...
const steps = [
  ...
  { key: "Detectando posiciones de texto...", icon: "📐" },
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md text-center space-y-8">
        ...
        />
        <div>
          <h2 className="text-2xl font-bold">Detectando texto</h2>
          <p className="text-muted-foreground mt-1 text-sm">
            La IA está analizando tu imagen para encontrar todos los textos...
          </p>
        </div>
